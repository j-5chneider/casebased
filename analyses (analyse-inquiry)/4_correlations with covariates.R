# corr Analyse 43_3 mit Kovariaten ####
library(corrgram)

corr_data43_3 <- diss_prepost_w_kovar_analy[c("A43_3"
                                              , "anz.komm.43.3"
...
# corr Analyse 43_4 mit Kovariaten ####
corr_data43_4 <- diss_prepost_w_kovar_analy[c("A43_4"
                                              , "anz.komm.43.4"
...
# corr Analyse 43_5 mit Kovariaten ####
corr_data43_5 <- diss_prepost_w_kovar_analy[c("A43_5"
                                              , "anz.komm.43.5"
